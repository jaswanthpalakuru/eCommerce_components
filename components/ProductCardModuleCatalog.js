...
// console.log(width);
export default function ProductCardModuleCatalog({
  color = "Black",
  Size = "L",
  price = 50,
  rating = 4,
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        <View style={styles.imageView}>
          ...
          {itemSoldOut ? null : (
            <View style={styles.addToFavouriteView}>
              <Button.AddToFavouritesWhite onPress={onPress} />
            </View>
          )}
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.value}>
            {itemSoldOut ? (
              <Text style={styles.itemSoldOut}>{price}$</Text>
            ) : discount ? (
...
const styles = StyleSheet.create({
  ...
  imageView: { width: width / 2 - 20 },
  image: { height: 200, width: width / 2 },
  labelView: { position: "absolute", top: 5, left: 5 },
  closeView: { position: "absolute", top: 10, right: 10 },
  addToFavouriteView: { position: "absolute", right: 0, bottom: -15 },
  ...
  itemSoldOut: { color: "black", fontSize: 14 },
  prevPrice: {
